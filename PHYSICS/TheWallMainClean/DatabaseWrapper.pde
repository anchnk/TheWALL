...
class DatabaseWrapper
{
  ...
  int getDis(int id)
  {
    String toCompare = queryProjectDis(id);
    
    //*/
    for(int i=0; i<disciplines.length; i++) {
      if(toCompare.equals(disciplines[i])) {
        return i;
      }
    }
    return 17; // sinon 6 => index de DIVERS
    //*/
      
    /*
    if(toCompare.equals("Arts plastiques"))
      return 0;
    else if(toCompare.equals("Bénévoles"))
      return 1;
    else if(toCompare.equals("Centre de presse"))
      return 2;
    else if(toCompare.equals("Danse"))
      return 3;
    else if(toCompare.equals("Débats"))
      return
      */
  }
}
